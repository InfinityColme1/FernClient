/// Componentes de interfaz compartidos por todas las features.
///
/// Importa este fichero para tener acceso a todo el catálogo:
/// `import 'package:Fern/core/ui/ui.dart';`
library;

export 'buttons/fern_action_button.dart';
export 'buttons/fern_add_button.dart';
export 'buttons/fern_confirm_button.dart';
export 'buttons/fern_pill_button.dart';
export 'dialogs/fern_color_picker_dialog.dart';
export 'dialogs/fern_dialog.dart';
...
export 'display/fern_broken_media.dart';
export 'display/fern_empty_state.dart';
export 'display/fern_region_selection_layer.dart';
export 'display/fern_progress_indicator.dart';
export 'display/region_painter.dart';
export 'display/fern_logo.dart';
export 'display/fern_motion.dart';
export 'display/fern_skeleton.dart';
export 'display/fern_scrollbar.dart';
export 'display/fern_section_header.dart';
export 'display/fern_surface.dart';
export 'display/fern_toast.dart';
export 'interaction/fern_drag_watch.dart';
...
export 'menus/fern_context_menu.dart';
